...
| R08-02 | Execute dependency/SBOM/container-config checks with versions and results. | issue test_results.md | VERIFIED_LOCAL_PARTIAL |
...
Trivy and candidate-matched live image evidence remain unavailable in this
session, so the issue remains open.
