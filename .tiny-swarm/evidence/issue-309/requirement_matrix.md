...
| R08-02 | Execute dependency/SBOM/container-config checks with versions and results. | issue test_results.md; trivy-scan-20260912.md | VERIFIED_LOCAL |
| R08-03 | Classify findings by profile applicability and disposition. | Security procedure; three-amigos-addendum.md | VERIFIED_LOCAL |
...
The local container-config finding is remediated and rescanned. Candidate
image identity and live boundary evidence remain open, so the issue remains
incomplete.
