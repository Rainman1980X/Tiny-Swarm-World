...
| R05-06 | Produce a real successful final-candidate run. | Workflow remains configured for disposable test runner | Hosted run 34717383985 reached runner but failed in preflight | BLOCKED_HOSTED_PREFLIGHT |
...
| R05-10 | Link successful run and evidence into RC1. | Release evidence consumer path defined | Successful hosted run pending; failed run evidence linked in `test_results.md` | BLOCKED_HOSTED_PREFLIGHT |
