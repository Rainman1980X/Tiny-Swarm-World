...
|---|---|---|---|---|
| R05-01 | Diagnose runner availability, labels, ownership and capabilities. | Nightly qualification and redacted runner payload | Static workflow contract; real runner observation pending | VERIFIED_LOCAL_PENDING_LIVE |
...
The issue remains open because no protected self-hosted runner execution was
