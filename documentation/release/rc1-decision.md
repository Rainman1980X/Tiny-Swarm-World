...
| Protected runner | #301 | PR #324, disposable test profile configured without credential rotation; seven GitHub variables set, Jenkins target image available, local Incus/LXC installation passed, hosted dispatch reached the runner but stopped in setup preflight ([run 34717383985](https://github.com/MatthiasBurger-Coder/Tiny-Swarm-World/actions/runs/34717383985)) | Successful final-candidate self-hosted run | OPEN |
