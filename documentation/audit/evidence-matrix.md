...
| `EVD-121-010` | User handbook | repository documentation | `documentation/user_guide/user-handbook.adoc` | REQ-121-080, REQ-121-102; MIN-01 | Present | No credentials, tokens or private host data | Operator-facing documentation source. |
